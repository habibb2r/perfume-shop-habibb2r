    ...
    return (
        <div className='flex justify-between items-center gap-5 px-[5%] py-[1.5%] bg-purple-50'>
            ...
            <div>
                ...
                <a  href="https://www.facebook.com/habibb2r"><img className='h-[25px] md:h-[45px]' src={fb} alt="" /></a>
                <a  href="https://linkedin.com/in/habibb2r"><img className='h-[25px] md:h-[45px]' src={linkedin} alt="" /></a>
                </div>
            </div>
        </div>
    );
